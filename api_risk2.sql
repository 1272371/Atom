...
--
-- Host: localhost
-- Generation Time: Sep 26, 2018 at 05:45 PM
...
INSERT INTO `grades` (`id`, `user_id`, `mark`, `module`, `weight`, `test_total`, `percentage`) VALUES
(1, 1234567, 45, 1, 1, 50, 90),
(2, 123456, 45, 1, 0, 50, 90),
(3, 78291, 49, 1, 0, 50, 98),
(4, 8383893, 20, 1, 0, 50, 40),
(5, 1234567, 43, 2, 1, 55, 78),
(6, 1234567, 50, 3, 0, 60, 83),
(7, 1234567, 30, 4, 0, 40, 75);
...
(13, '351b65e702b0a08fe0cf1abfb1c444cf1a2098e3', 1);
...
(6, '78291', 'Staff', 'Hello', 'World', '$2y$10$VZiItd9GKVj98arr7CR4L.WxBbScplLZh.KosQuhBy3xBefPJ/Ufi', 'Science', 'Physics', 2008),
